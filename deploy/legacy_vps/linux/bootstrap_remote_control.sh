...
Next steps:
1. Copy deploy/legacy_vps/linux/remote_control.env.example to /etc/emploai/remote-control.env
2. Fill in your secrets and paths
3. Install deploy/legacy_vps/linux/emploai-remote-control.service
4. Install deploy/legacy_vps/linux/nginx-remote-control.conf
EOF
