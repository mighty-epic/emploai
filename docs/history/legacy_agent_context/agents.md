...
4. **Review the `agent/` folder** to understand agent implementations:
   - `legacy_agent_orchestration/dual_agent/` — Coordinator, Executor, Memory agents
   - `legacy_agent_orchestration/unified_agent.py` — Unified agent logic
   - `legacy_agent_orchestration/orchestrator.py` — Core orchestration
...
### 20. CONSULT LOCAL DOCUMENTATION(for system prompts)
