...
contextBridge.exposeInMainWorld('emploaiDesktop', {
  ...
  fleet: {
    ...
    deleteWorkerOnComputer: (payload) => ipcRenderer.invoke('emploai:fleet:delete-worker-on-computer', payload),
    ...
    computerUpdateStatus: (payload) => ipcRenderer.invoke('emploai:fleet:computer-update-status', payload),
    checkComputerUpdate: (payload) => ipcRenderer.invoke('emploai:fleet:check-computer-update', payload),
    startComputerUpdate: (payload) => ipcRenderer.invoke('emploai:fleet:start-computer-update', payload),
    requestComputerPermissions: (payload) => ipcRenderer.invoke('emploai:fleet:request-computer-permissions', payload),
    decideUpstreamRequest: (payload) => ipcRenderer.invoke('emploai:fleet:decide-upstream-request', payload),
    ...
    yggdrasilActivity: () => ipcRenderer.invoke('emploai:fleet:yggdrasil-activity'),
    yggdrasilRequestManager: (payload) => ipcRenderer.invoke('emploai:fleet:yggdrasil-request-manager', payload),
