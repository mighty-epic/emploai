...
function schedulePairedFleetHostStart(delayMs = fleetHostStartupDelayMs) {
  ...
  fleetHostStartupTimer = setTimeout(() => {
    fleetHostStartupTimer = null;
    fleetYggdrasilServices().startHost().catch(() => {
...
app.whenReady().then(async () => {
  ...
  ipcMain.handle('emploai:fleet:computer-update-status', async (_event, payload) => remoteControlServices().fleetComputerUpdateStatus(payload || {}));
  ipcMain.handle('emploai:fleet:check-computer-update', async (_event, payload) => remoteControlServices().fleetCheckComputerUpdate(payload || {}));
  ipcMain.handle('emploai:fleet:start-computer-update', async (_event, payload) => remoteControlServices().fleetStartComputerUpdate(payload || {}));
  ...
  ipcMain.handle('emploai:fleet:yggdrasil-permissions', async () => fleetYggdrasilServices().permissions());
  ipcMain.handle('emploai:fleet:yggdrasil-set-permissions', async (_event, payload) => fleetYggdrasilServices().setPermissions(payload || {}));
  ipcMain.handle('emploai:fleet:yggdrasil-decide-permission-request', async (_event, payload) => fleetYggdrasilServices().decidePermissionRequest(payload || {}));
  ipcMain.handle('emploai:fleet:yggdrasil-activity', async () => fleetYggdrasilServices().activity());
  ipcMain.handle('emploai:fleet:yggdrasil-request-manager', async (_event, payload) => fleetYggdrasilServices().requestManager(payload || {}));
