...
const styles = StyleSheet.create({
  ...
  editor: { paddingHorizontal: 14, paddingBottom: 14, borderTopWidth: 1, borderTopColor: UI.color.border },
  coreRow: { minHeight: 50, paddingVertical: 7, flexDirection: 'row', alignItems: 'center', gap: 12, borderBottomWidth: 1, borderBottomColor: UI.color.border },
  coreCopy: { flex: 1, minWidth: 0 },
  required: { color: UI.color.success, fontFamily: UI.type.mono, fontSize: TYPE.micro, fontWeight: '900' },
  packRow: { minHeight: 50, paddingVertical: 7, flexDirection: 'row', alignItems: 'center', gap: 12, borderBottomWidth: 1, borderBottomColor: UI.color.border },
