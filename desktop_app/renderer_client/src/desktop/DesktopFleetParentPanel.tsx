...
const styles = StyleSheet.create({
  section: { padding: 16, gap: 14, borderWidth: 1, borderColor: UI.color.border, borderRadius: UI.radius.large, backgroundColor: UI.color.surface },
  ...
  parentCard: { minHeight: 112, padding: 16, borderWidth: 1, borderColor: UI.color.borderStrong, borderRadius: UI.radius.large, backgroundColor: UI.color.canvas, flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: 14 },
  parentCardConnected: { borderColor: UI.color.accentBorder, backgroundColor: UI.color.accentSoft },
