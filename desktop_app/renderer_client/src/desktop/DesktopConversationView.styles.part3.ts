...
export const desktopConversationStylesPart3 = StyleSheet.create({
  ...
  modelPickerCompactContent: {
    gap: 0,
    paddingVertical: 2,
  },
  modelPickerCompactGroup: {
    gap: 1,
  },
  modelPickerCompactLabel: {
    color: '#8f8f8f',
    fontSize: 12,
    lineHeight: 18,
    paddingHorizontal: 10,
  ...
  modelPickerCompactRowHovered: {
    backgroundColor: 'rgba(255, 255, 255, 0.05)',
  },
  modelPickerCompactRowCopy: {
    flex: 1,
    minWidth: 0,
  },
  modelPickerCompactKicker: {
    color: '#8f8f8f',
    fontSize: 10,
    lineHeight: 13,
  },
  modelPickerCompactText: {
    color: '#f6f6f6',
    fontSize: 13,
    lineHeight: 18,
  },
  modelPickerCompactCheck: {
    color: '#f6f6f6',
    fontSize: 14,
    lineHeight: 18,
  },
  modelPickerCompactChevron: {
    color: '#9d9d9d',
    fontSize: 12,
  },
  modelPickerCompactDivider: {
    height: 1,
    backgroundColor: 'rgba(255, 255, 255, 0.09)',
    marginVertical: 5,
  },
  modelPickerPlannerBody: {
    gap: 5,
    paddingTop: 4,
  },
  modelPickerSection: {
  ...
  composerModeActionHovered: {
    backgroundColor: '#14223d',
  },
  composerModeActionActive: {
    backgroundColor: '#20314f',
  },
  composerModeActionDisabled: {
    opacity: 0.5,
  },
  composerModeActionTitle: {
    color: '#f3f6ff',
    fontSize: 13,
    fontWeight: '900',
  },
  composerModeActionText: {
    color: '#9db0cf',
    fontSize: 11,
    lineHeight: 15,
  },
  ...
  editSummaryAdditions: {
    color: '#35d978',
  },
  editSummaryDeletions: {
    color: '#ff6c73',
  },
  editSummaryFileList: {
    borderTopWidth: 1,
    borderTopColor: '#303239',
  },
  editSummaryFileRow: {
    minHeight: 34,
    flexDirection: 'row',
  ...
  editSummaryToggleHovered: {
    backgroundColor: '#282a2f',
  },
  editSummaryToggleText: {
    color: '#f3f5f8',
    fontSize: 12,
    fontWeight: '700',
  },
  editSummaryToggleChevron: {
    color: '#aab2c0',
    fontSize: 12,
    fontWeight: '900',
  },
  ...
  timelineRunDisclosureWarn: {
    borderTopColor: '#4a391d',
  },
  timelineRunDisclosureError: {
    borderTopColor: '#4d2d39',
  },
  timelineRunHeader: {
    minHeight: 30,
    flexDirection: 'row',
  ...
  timelineRunHeaderHovered: {
    backgroundColor: '#202329',
  },
  timelineRunHeaderCopy: {
    flex: 1,
    minWidth: 0,
  },
  timelineRunTitle: {
  ...
  timelineRunEventRowWarn: {
    backgroundColor: '#18150d',
  },
  timelineRunEventRowError: {
    backgroundColor: '#1a1014',
  },
  timelineRunEventHeader: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
    gap: 10,
  },
  timelineRunEventEyebrow: {
    color: '#9fc7ff',
    fontSize: 10,
    fontWeight: '900',
    textTransform: 'uppercase',
  },
  timelineRunEventTime: {
    color: '#778397',
    fontSize: 10,
  },
  timelineRunEventBody: {
    color: '#dbe4f2',
    fontSize: 12,
    lineHeight: 18,
  },
