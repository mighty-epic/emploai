...
const styles = StyleSheet.create({
  panel: { padding: 16, gap: 13, borderWidth: 0, borderRadius: UI.radius.large, backgroundColor: UI.color.surfaceMuted },
  ...
  closeButton: { width: 44, height: 44, borderWidth: 0, backgroundColor: UI.color.surfaceRaised, borderRadius: UI.radius.control, alignItems: 'center', justifyContent: 'center' },
  closeButtonText: { color: UI.color.textMuted, fontSize: 20 },
  addressRow: { padding: 10, borderWidth: 0, borderRadius: UI.radius.control, backgroundColor: UI.color.surface },
  ...
  secondaryButton: { minHeight: 44, paddingHorizontal: 12, borderWidth: 0, borderRadius: UI.radius.control, backgroundColor: UI.color.accentSoft, alignItems: 'center', justifyContent: 'center' },
