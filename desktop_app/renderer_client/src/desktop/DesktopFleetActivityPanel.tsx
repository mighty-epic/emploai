...
const styles = StyleSheet.create({
  panel: { paddingVertical: 18, gap: 14, borderWidth: 0, borderRadius: 0, backgroundColor: 'transparent' },
  ...
  refreshButton: { minHeight: 44, paddingHorizontal: 13, borderWidth: 0, backgroundColor: UI.color.surfaceMuted, borderRadius: UI.radius.control, alignItems: 'center', justifyContent: 'center' },
  refreshButtonText: { color: UI.color.textMuted, fontSize: TYPE.body, fontWeight: '800' },
  summaryRow: { flexDirection: 'row', flexWrap: 'wrap', borderTopWidth: 1, borderBottomWidth: 1, borderColor: UI.color.border },
  summaryCard: { flexGrow: 1, flexBasis: 145, minWidth: 125, paddingVertical: 11, paddingRight: 18, borderWidth: 0, backgroundColor: 'transparent' },
  ...
  column: { flexGrow: 1, flexBasis: 340, minWidth: 280, paddingTop: 13, gap: 9, borderTopWidth: 1, borderTopColor: UI.color.border, backgroundColor: 'transparent' },
  ...
  activityCard: { paddingVertical: 10, gap: 6, borderBottomWidth: 1, borderBottomColor: UI.color.border, backgroundColor: 'transparent' },
  ...
  emptyState: { paddingVertical: 12, borderWidth: 0 },
  ...
  identityButton: { minHeight: 48, paddingHorizontal: 10, paddingVertical: 7, borderWidth: 0, backgroundColor: UI.color.surfaceMuted, borderRadius: UI.radius.control, justifyContent: 'center' },
  identityButtonSelected: { backgroundColor: UI.color.accentSoft },
  ...
  kindButton: { flexGrow: 1, flexBasis: 105, minHeight: 48, padding: 10, borderWidth: 0, backgroundColor: UI.color.surfaceMuted, borderRadius: UI.radius.control, justifyContent: 'center' },
  kindButtonSelected: { backgroundColor: UI.color.accentSoft },
  ...
  requestCard: { flexGrow: 1, flexBasis: 245, minWidth: 220, maxWidth: 390, paddingVertical: 10, gap: 6, borderBottomWidth: 1, borderBottomColor: UI.color.border, backgroundColor: 'transparent' },
