...
def build_bot_commands() -> list[BotCommand]:
    return [
        ...
        BotCommand("identity", "Show or switch Fleet identity"),
        BotCommand("manager", "Switch to manager identity"),
        BotCommand("workers", "List Fleet workers"),
        ...
        BotCommand("schedule", "Create automation"),
        BotCommand("automations", "List automations"),
        BotCommand("automation_run", "Run automation now"),
        BotCommand("automation_pause", "Pause automation"),
        BotCommand("automation_resume", "Resume automation"),
        BotCommand("automation_delete", "Delete automation"),
        BotCommand("confirm", "Approve pending confirmation"),
        BotCommand("deny", "Deny pending confirmation"),
        BotCommand("jobs", "List automations"),
        BotCommand("job_remove", "Remove automation"),
