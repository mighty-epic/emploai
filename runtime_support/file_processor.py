"""
File and media processing helpers.

Handles images, PDFs, documents, and other media files for local control
surfaces.
"""
...
class FileProcessor:
    """
    Processes various file types sent through supported control surfaces.
