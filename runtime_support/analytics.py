"""
Runtime analytics and insights.

Tracks usage, skills, tokens, and response timings for local control surfaces.
"""
...
class AnalyticsTracker:
    """
    Tracks usage analytics for local agent surfaces.
